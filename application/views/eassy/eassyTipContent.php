 ...
 <div class="top_title">
  <div class="wraper">
   ...
   <ul>
    ...
    <li><?php echo $eassytip[0]['title']?></li>
   </ul>
  </div>
 </div>
 <!-- /top_title -->
  ...
  <div class="portfolio_sidebar">
   <ul class="gallery">
    <li>
     ...
     <div class="desc">
      <h5><a href="single_full.html"><?php echo $eassytip[0]['title']?></a> <span>by <?php echo $eassytip[0]['author']?>  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo date('m-d-y', $eassytip[0]['ctime'])?></span></h5>
      <?php echo $eassytip[0]['content']?>
