 ...
 <div class="wraper">
  ...
  <div class="portfolio_sidebar">
   ...
   <?php foreach ($eassytip as $v): ?>
    <li>     
     <div class="desc">
      <h5><a href="<?php echo site_url().'/eassy/eassyTipList/showTipContent/'.$v['id'] ?>"><?php echo $v['title']?> </a> <span>by <?php echo $v['author']?>  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo date('m-d-y', $v['ctime'])?></span></h5>
      <p><?php echo $v['desc']?> ...</p>
      <p  style="float:right"><a class="read_more btn_col" href="<?php echo site_url().'/eassy/eassyTipList/showTipContent/'.$v['id'] ?>">Read More</a></p>
     </div>
    </li>
   <?php endforeach; ?>
